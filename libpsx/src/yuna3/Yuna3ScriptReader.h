#ifndef YUNA3SCRIPTREADER_H
#define YUNA3SCRIPTREADER_H
...
//  typedef std::map<int, int> CharSizeTable;
  ...
  Yuna3ScriptReader(BlackT::TStream& src__,
...
//  bool checkSymbol(BlackT::TStream& ifs, std::string& symbol);
  ...
  void outputVramOverrideCommand(int x, int y);
